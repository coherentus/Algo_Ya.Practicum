# https://contest.yandex.ru/contest/25597/run-report/69639325/
...
# Тогда для текущего индекса dp_idx необходимо эл-т dp[dp_idx] отметить
...
# Итого:
# O(N) + O(N * logN) + O(N * K/2) или,
# после упрощения - O(N * logN) + O(N * K), O(N * (logN + K)),
# где N - кол-во эл-тов во входной последовательности, K - их сумма.
# Пространственная сложность.
# Ввод и хранение всех значений - O(N), где N - кол-во эл-тов входной после-
# довательности.
# Для работы алгоритма необходим массив из K эл-тов, где K - полусумма, умень-
# шенная на значение максимального эл-та. После сокращения констант сложность
# составит O(K), где - сумма всех эл-тов входной последовательности.
# Итоговая пространственная сложность - O(N) + O(K), или O(N + K), где
# N - кол-во эл-тов, а K - сумма эл-тов входной последовательности.
