    # https://contest.yandex.ru/contest/24414/run-report/66166488/
    ...
    # Кол-во хранимых ключей -  100000
    FIBONACCI = 2654435769
    P_CONST = 17
    HASH_TABLE_SIZE = 2 ** P_CONST  # 2**17 == 131072
                                    # 2**16 < 100000 < 2**17
    BITWISE = 32 - P_CONST
    ...
    class HashTable:
        ...
        def __get_index(self, key: str) -> int:
            ...
            return ((int(key) * FIBONACCI) >> BITWISE) % HASH_TABLE_SIZE
